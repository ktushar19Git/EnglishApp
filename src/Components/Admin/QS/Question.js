                ...
                */
                ...
                axios.post('http://localhost:4000/app/Question', question)
                    .then(response => {
                       ...
                       //response.json({data:JSON.stringify(response)})
                    ...
                    <td>
                        ...
                        <table class="DataEntryTable">
                            ...
                            <tr>
                                ...
                                <td>
                                    <Form.Group controlId="formGridState">
                                        <Form.Control as="select" value={selSubject} onChange={e=>handleSubjectChange(e)} >
                                          <option>Select Subject</option>
                                           {Chapter && Chapter.map(item=>{
                                               return(
                                                   <option key={item._id} value={item._id}onChange={e=>handleSubjectChange(e)}>{item.Subject}</option>
                                               )
                            ...
                            <tr>
                                ...
                                <td>
                                    <Form.Group controlId="formGridState">
                                        <Form.Control as="select" value={selChapter} onChange={e=>handleChapterChange(e)} >
                                        <option>Select Chapter</option>
                                            {Chapter && Chapter.map(item => {
                                                if(item._id===selSubject){
                                                 return item.chapters.map(sub=>{
                                                    return (
                                                        <option key={sub._id} value={sub._id}onChange={e=>handleChapterChange(e)}>{sub.ChapterName}</option>
                                                    )
                                                })
                                            }
                                            })}
